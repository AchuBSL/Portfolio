...
// user name validation
    if(user_name==""){
        ...
        setError(userNameInput,"User Name Must be at least 5")
        return false;
    }else{
...
// email validation 
    if(email==""){
        ...
        setError(emailInput, "Enter the valid email")
        return false;
    }
    ...
    if(subject==""){
      setError(subjectInput,"Write subject")
      return false
    }else{
    ...
    if(message==""){
      setError(messageInput,"Write message")
      return false
    }else{
...
// password validation
  ...
  //   setError(passwordInput,"Password must be at least 8");
  //   return false;
  // }else{
